...
component(java8).
component(mysqld4e5f6db).
component(nodejsg7h8i94a1b2c34).
component(ocbtopic).
component(nodejsg7h8i94a1b2c34g7h8i9app).
...
component_of_type(homeassistant, homeassistant).
component_of_type(homeassistantd4e5f6dockercontainer, homeassistantd4e5f6dockercontainer).
component_of_type(java8, java8).
component_of_type(mysqld4e5f6db, mysqld4e5f6db).
component_of_type(nodejsg7h8i94a1b2c34, nodejsg7h8i94a1b2c34).
component_of_type(ocbtopic, ocbtopic).
component_of_type(nodejsg7h8i94a1b2c34g7h8i9app, nodejsg7h8i94a1b2c34g7h8i9app).
...
relation(flinkapp, homeassistant, cong7h8i9115).
relation(homeassistant, homeassistantd4e5f6dockercontainer, cong7h8i9116).
relation(homeassistantd4e5f6dockercontainer, java8, cong7h8i9117).
relation(java8, mysqld4e5f6db, cong7h8i9118).
relation(mysqld4e5f6db, nodejsg7h8i94a1b2c34, cong7h8i9119).
relation(flinkapp, multisensor, cong7h8i9120).
relation(multisensor, homeassistantg7h8i92, cong7h8i9121).
...
relation_of_type(cong7h8i9115, hostedon).
relation_of_type(cong7h8i9116, dependson).
relation_of_type(cong7h8i9117, hostedon).
relation_of_type(cong7h8i9118, hostedon).
relation_of_type(cong7h8i9119, hostedon).
relation_of_type(cong7h8i9120, connectsto).
relation_of_type(cong7h8i9121, hostedon).
...
hosting_stack([multisensor, homeassistantg7h8i92]).
